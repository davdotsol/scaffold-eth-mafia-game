...
/**
 * Deploys a contract named "MafiaGame" using the deployer account and
...
const deployMafiaGame: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  console.log("👋 Initial mayor address:", await mafiaGame.mayor());
};

export default deployMafiaGame;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags MafiaGame
